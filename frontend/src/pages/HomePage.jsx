...
const HomePage = ({ onPageChange, onPuppySelect }) => {
    ...
    return (
        <div className="flex flex-col">
            ...
            <section className="relative h-[850px] w-full overflow-hidden bg-forest-green">
                ...
                <div className="fixed-layout relative h-full flex flex-col justify-center px-10">
                    <div className="max-w-2xl animate-in fade-in slide-in-from-left-8 duration-1000">
                        <span className="font-inter text-xs uppercase tracking-[0.4em] text-champagne-gold mb-6 block drop-shadow-lg">44 Years of Trust • Family Business</span>
                        <h1 className="font-playfair text-7xl text-white leading-tight mb-8 drop-shadow-2xl">
                            Find Your New <br />
                            <span className="italic text-champagne-gold">Best Friend.</span>
                        </h1>
                        <p className="font-inter text-lg text-ivory-white/90 leading-relaxed mb-10 max-w-xl drop-shadow-md">
                    ...
                    <div className="absolute right-10 bottom-20 flex space-x-12">
                        <div className="text-white drop-shadow-lg">
                            <div className="font-playfair text-4xl mb-1 text-champagne-gold">24+</div>
                            <div className="font-inter text-[10px] uppercase tracking-widest opacity-70">Happy Litters</div>
                        </div>
                        <div className="text-white drop-shadow-lg">
                            <div className="font-playfair text-4xl mb-1 text-champagne-gold">180+</div>
            ...
            {/* Trust Bar */}
            <div className="bg-ivory border-b border-champagne-gold/10 py-10 shadow-sm">
                <div className="fixed-layout px-10 flex justify-between items-center opacity-40 grayscale hover:opacity-70 transition-opacity">
                    <div className="flex items-center space-x-3">
                        <Award size={32} />
                        <span className="font-playfair font-bold text-xl tracking-tighter">CERTIFIED BREEDERS</span>
                    </div>
                    <div className="flex items-center space-x-3">
                        <ShieldCheck size={32} />
                        <span className="font-playfair font-bold text-xl tracking-tighter">HEALTH CLEARANCE</span>
                    </div>
                    <div className="font-playfair font-bold text-2xl tracking-tighter">KCI REGISTERED</div>
                    <div className="font-playfair font-bold text-2xl tracking-tighter italic">ESTD. 1982</div>
                </div>
            </div>

            {/* Featured Puppies Grid */}
            <section id="puppies" className="bg-white py-32">
                <div className="fixed-layout px-10">
                    <div className="flex justify-between items-end mb-20 border-b border-forest-green/5 pb-10">
                        <div>
                            <span className="font-inter text-xs uppercase tracking-widest text-forest-green/60 mb-4 block">Our Current Selection</span>
                            <h2 className="text-6xl text-forest-green font-playfair">Featured Puppies</h2>
                        </div>
                        <button
                            onClick={() => onPageChange('puppies')}
                            className="flex items-center space-x-2 text-forest-green font-bold uppercase tracking-widest text-xs group"
                        >
            ...
            <section className="bg-forest-green py-32 text-ivory-white overflow-hidden relative">
                <div className="absolute top-0 right-0 w-1/3 h-full bg-champagne-gold/5 blur-[120px] rounded-full"></div>

                <div className="fixed-layout px-10 relative z-10">
                    <div className="grid grid-cols-2 gap-20 items-center">
                        <div>
                            <span className="font-inter text-xs uppercase tracking-[0.4em] text-champagne-gold/60 mb-6 block">Care for Life</span>
                            <h2 className="text-6xl text-white font-playfair mb-8 leading-tight">Professional Services for <br /><span className="italic text-champagne-gold">Every Stage.</span></h2>
                            <p className="font-inter text-lg text-ivory-white/60 mb-12 max-w-lg leading-relaxed">
                                From the first grooming session to lifelong boarding and training, we are here to support you and your new companion.
                            </p>
                            <button
                                onClick={() => onPageChange('services')}
                                className="px-10 py-5 bg-champagne-gold text-forest-green font-bold uppercase tracking-widest text-xs rounded-lg hover:scale-105 transition-all"
                            >
                                Book a Service
                            </button>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            {[
                                ...
                                <div key={i} className="bg-white/5 border border-white/10 p-8 rounded-24 hover:bg-white/10 transition-colors">
                                    <s.icon className="text-champagne-gold mb-6" size={24} />
            ...
            {/* Stud Availability Preview (New Section) */}
                ...
                <div className="fixed-layout px-10">
                    <div className="flex items-center space-x-12">
                        <div className="flex-1">
                            ...
                            <h2 className="text-5xl text-forest-green font-playfair mb-8">Champion Stud Dogs</h2>
                            <p className="font-inter text-forest-green/60 mb-8 max-w-lg leading-relaxed">
                            ...
                            <button
                                ...
                                className="flex items-center space-x-3 text-forest-green font-bold uppercase tracking-widest text-xs group"
                            >
                        ...
                        <div className="flex-1 grid grid-cols-2 gap-4">
                            <div className="rounded-24 overflow-hidden h-[400px]">
                            ...
                            <div className="rounded-24 overflow-hidden h-[400px] mt-12">
            ...
            <section className="py-32 bg-white">
                <div className="fixed-layout px-10 text-center">
                    <span className="font-inter text-xs uppercase tracking-[0.4em] text-forest-green/40 mb-6 block">Customer Stories</span>
                    <h2 className="text-5xl text-forest-green font-playfair mb-20 leading-tight">Shared Love for <br /><span className="italic">Grown Pups.</span></h2>

                    <div className="grid grid-cols-3 gap-12">
                        {testimonials.map((t, i) => (
                            <div key={i} className="text-left p-10 bg-ivory/30 rounded-24 border border-forest-green/5 hover:border-champagne-gold/40 transition-all group">
                                <div className="flex space-x-1 mb-6">
                                    {[1, 2, 3, 4, 5].map(star => <Star key={star} size={14} fill="#C5A059" className="text-champagne-gold" />)}
                                </div>
                                <p className="font-inter text-forest-green/80 italic mb-8 leading-relaxed">"{t.text}"</p>
            ...
            <section className="bg-ivory py-32">
                <div className="fixed-layout px-10 flex flex-col items-center text-center">
                    <LitterCounter />
                    <p className="mt-8 font-inter text-forest-green/40 text-xs uppercase tracking-widest mb-12">Puppies found their homes in 44 years</p>
                    <h3 className="text-4xl text-forest-green font-playfair mb-8 max-w-2xl">Ready to welcome your next family member?</h3>
                    <button
                        onClick={() => onPageChange('contact')}
                        className="px-12 py-6 bg-forest-green text-champagne-gold font-bold uppercase tracking-widest text-xs rounded-lg shadow-2xl hover:scale-105 transition-transform"
                    >
