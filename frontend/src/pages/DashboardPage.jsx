                ...
                return (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="lg:bg-white lg:p-10 lg:rounded-32 lg:border lg:border-forest-green/10 lg:shadow-sm max-w-2xl">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8 mb-8 lg:mb-10">
                                <div className="space-y-1.5 lg:space-y-2">
                                    <label className="font-inter text-xs uppercase tracking-wider text-forest-green/40 font-bold ml-1">First Name</label>
                                    <input type="text" defaultValue="Ganesh" className="w-full p-4 bg-white lg:bg-ivory rounded-xl border border-forest-green/10 lg:border-forest-green/5 font-inter text-sm text-forest-green/80 focus:ring-2 focus:ring-forest-green/20 outline-none transition-all" />
                                </div>
                                <div className="space-y-1.5 lg:space-y-2">
                                    <label className="font-inter text-xs uppercase tracking-wider text-forest-green/40 font-bold ml-1">Last Name</label>
                                    <input type="text" defaultValue="Hegde" className="w-full p-4 bg-white lg:bg-ivory rounded-xl border border-forest-green/10 lg:border-forest-green/5 font-inter text-sm text-forest-green/80 focus:ring-2 focus:ring-forest-green/20 outline-none transition-all" />
                                </div>
                                <div className="sm:col-span-2 space-y-1.5 lg:space-y-2">
                                    ...
                                    <input type="email" defaultValue="ganesh.hegde@example.com" className="w-full p-4 bg-white lg:bg-ivory rounded-xl border border-forest-green/10 lg:border-forest-green/5 font-inter text-sm text-forest-green/80 focus:ring-2 focus:ring-forest-green/20 outline-none transition-all" />
                                </div>
                            </div>
                            <button
                    ...
                    <div className="space-y-10 lg:space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div>
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                                {[
                                    { label: 'Total Bookings', value: '00', id: 'summary', mobileHidden: true },
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[1, 2].map((i, idx) => (
                                    <div key={i} className={`bg-white p-6 lg:p-8 rounded-24 border border-forest-green/10 flex flex-col sm:flex-row sm:items-center justify-between group hover:border-forest-green/40 transition-colors gap-4 lg:gap-6 ${idx > 0 ? 'hidden lg:flex' : ''}`}>
                                        <div className="flex items-center space-x-6 lg:space-x-8">
                                            <div className="w-16 h-16 lg:w-20 lg:h-20 bg-forest-green/5 rounded-xl flex flex-col items-center justify-center shrink-0">
                                                <span className="font-inter text-[10px] lg:text-[10px] uppercase font-bold text-forest-green/40">March</span>
                                                <span className="font-playfair text-2xl lg:text-3xl text-forest-green leading-none">15</span>
                                            </div>
                                            <div>
                                                <h4 className="font-playfair text-lg lg:text-xl text-forest-green mb-1 truncate w-40 sm:w-auto">Elite Grooming</h4>
                                                <p className="font-inter text-sm lg:text-sm text-forest-green/40">Order ID: #NS-928{i}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center justify-between sm:justify-end space-x-6 lg:space-x-6">
                                            <div className="sm:text-right">
                                                <div className="text-xs lg:text-sm font-bold text-forest-green tracking-wider uppercase">Confirmed</div>
                                                <div className="text-xs lg:text-xs text-forest-green/40">09:00 AM @ Beverly Hills</div>
                                            </div>
        ...
        <div className="fixed-layout py-6 lg:py-16 px-4 lg:px-10 min-h-screen">
            <div className="flex flex-col lg:flex-row lg:space-x-12">
                ...
                <div className="lg:w-[300px] shrink-0 mb-8 lg:mb-0">
                    {/* Mobile: Centered Header (No card borders) */}
                    <div className="lg:hidden flex flex-col items-center mb-10 text-center">
                        ...
                        <h2 className="font-playfair text-2xl text-forest-green tracking-tight font-bold">Ganesh Hegde</h2>
                        <p className="font-inter text-sm text-forest-green/60 mt-1">Customer since 2025</p>
                    </div>

                    {/* Desktop Sidebar (Structured Card) */}
